...
function showrecentposts(json) {
	document.write('<table width="'+tablewidth+'" border=0 bordercolor="#FF0000" cellspacing="'+cellspacing+'" bgcolor="'+borderColor+'" align="right">');
...
posttitle = (aBold) ? "<b>"+posttitle+"</b>" : posttitle;
	...
	if(summaryPost == 0) { td = '<td align="right" valign="top" width="'+imgwidth+'" height="'+imgheight+'" style="background:'+bgTD+'"><a href="'+posturl+'"><img src="'+img[i]+'" width="'+imgwidth+'" height="'+imgheight+'"/></a><br />'+icon+'<a href="'+posturl+'" style="color:'+acolor+'; font-size:'+fntsize+'px;">'+posttitle+'</a><br/>' + daystr + '</td>'; }
